  ...
  async connectedCallback() {
    ...
    try {
      ...
      if (img) {
        const actualizarImagen = () => {
          if (window.innerWidth <= 768) {
            img.src = "/novaenvios/assets/bienvenida_android.png";
          } else {
            img.src = "/novaenvios/assets/bienvenida.png";
          }
        };
      ...
      if (this.versionApp) {
        ...
        if (versionLabel) {
          versionLabel.textContent = `NovaEnvios v${this.versionApp}`; //la version se actualiza desde el main mas preciso desde el swworker
        }
      }
